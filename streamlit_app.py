...
with st.container(border=True):
    ...
    if prompt := st.chat_input("궁금한 내용을 입력하세요!"):
        ...
        with st.chat_message("assistant"):
            ...
            {"role": "system", "content": "너의 답변은 정확하고, 핵심 위주로 간결하고, 가독성이 높게 작성한다. 시스템 사용법 문의와 관련없는 사용자 질문에 대해서는 답변하지 않는다.답변의 마지막에 따라하기 메뉴얼의 어디를 참고하면 되는지 알려준다. '출처'와 '출처 내 위치'를 제공한다."}
            ] + st.session_state.messages + [
