...
with st.container(border=True):
    ...
    if prompt := st.chat_input("궁금한 내용을 입력하세요!"):
        ...
        with st.chat_message("assistant"):
            ...
            ## 관련자료에 대하여
            - 너는 '2024년 기준으로 업데이트된 관련자료(따라하기 메뉴얼, 교육동영상 대본)'를 시용자(질문자)의 질문에 따라 RAG(Retrieval-Augmented Generation)방식으로 조회하여 제공받는다.

            ## 관련자료의 형식
            - 관련자료의 각각은 '출처', '출처 내 위치', '내용'으로 구성되어 있다.
            - '\n' 문자는 한줄 뛰어져 있다는 의미다.
            ...
            - 시스템 사용법 문의와 관련없는 질문에 대해서는 답변하지 않는다. 정확한 답변만 작성하고 관련자료에 내용이 없는 질문에 대해서는 알지 못한다고 답한다.
            - 너는 시용자(질문자)가 질문에 출처를 알려달라고 하기 전에는 관련자료의 출처를 먼저 제공하진 않는다.
