...
with st.container(border=True):
    ...
    if prompt := st.chat_input("궁금한 내용을 입력하세요!"):
        ...
        with st.chat_message("assistant"):
            ...
            {"role": "system", "content": "반드시 답변의 마지막에 사용자(질문자)가 추가 내용을 확인할 수 있도록 질문과 관련성이 높은 관련자료들의 '출처'와 '위치'를 포함한다. 답변 마지막에 한줄 뛰고 '출처: <관련자료의 출처>, 위치: <관련자료의 출처 내 위치>' 형식으로 알려준다. 제공할 관련자료들이 여러개라면 한줄씩 뛰고 나열한다."},
