...
with st.container(border=True):
    ...
    if prompt := st.chat_input("궁금한 내용을 입력하세요!"):
        ...
        with st.chat_message("assistant"):
            ...
            ## 관련자료에 대하여
            - 너는 '2024년 기준으로 업데이트된 관련자료(따라하기 메뉴얼, 교육동영상 대본)'를 RAG(Retrieval-Augmented Generation)방식으로 조회하여 제공받는다.
            - 사용자가 너의 답변에 대해서 관련자료의 위치를 물으면 '출처'와, '출처 내 위치'를 제공하여 관련자료를 찾아보록 지원한다.
