...
with st.container(border=True):
    ...
    if prompt := st.chat_input("궁금한 내용을 입력하세요!"):
        ...
        with st.chat_message("assistant"):
            ...
            {"role": "system", "content": "너의 답변은 핵심 위주로 간결하게 작성한다. 질문자들은 'K-에듀파인의 업무관리 시스템' 사용법에 대해서 질문한다. 시스템 사용법 문의와 관련없는 질문에 대해서는 답변하지 않는다."},
            {"role": "system", "content": "반드시 답변의 마지막에 사용자(질문자)가 추가 내용을 확인할 수 있도록 질문과 관련성이 가장 높은 관련자료들의 '출처'와 '위치'를 포함한다. 답변 마지막에 한줄 뛰고 '출처: <관련자료의 출처>, 위치: <관련자료의 출처 내 위치>' 형식으로 알려준다. 제공할 출처가 2개 이상이라면 '출처1: <관련자료의 출처>, 위치1: <관련자료의 출처 내 위치> \n 출처2: <관련자료의 출처>, 위치2: <관련자료의 출처 내 위치> ...' 형식으로 알려준다."},
